...
const Sidebar = ({ isSideBarToggled, setIsSideBarToggled, setPageName }) => {
  ...
  return (
    <>
      <aside
        className={` flex flex-col lg:relative fixed z-500 min-h-screen bg-gray-900 text-white h-full lg:overflow-x-visible overflow-x-auto  py-2 transition-all duration-300 ease-in-out  ${
          isSideBarToggled
            ? "w-[280px] px-2"
